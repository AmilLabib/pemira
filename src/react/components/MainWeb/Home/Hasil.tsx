...
const Hasil: React.FC = () => {
  ...
  return (
    <section className="mx-auto my-8 w-full lg:px-6">
      <div className="mx-auto w-[90vw] rounded-2xl bg-white py-8 opacity-90 shadow-xl lg:w-[65vw]">
        <div className="relative mx-auto w-[90%] rounded-2xl bg-[#344e95] px-6 py-8 text-white">
          {/* top centered ribbon */}
          ...
          <div className="grid grid-cols-1 items-center gap-4 md:grid-cols-12">
            <div className="w-full md:col-span-5">
              <div className="grid gap-6">
                <div className="flex flex-col items-center gap-4 md:flex-row md:justify-between">
                  <div className="font-league text-center text-lg font-bold md:text-left md:text-sm lg:text-xl">
                    Suara masuk onsite :
                  </div>
                  <Donut
                    value={onsite}
            ...
            <div className="text-center md:col-span-3">
              <div className="font-league text-xl font-bold whitespace-nowrap md:text-lg lg:text-2xl">
                Total Suara Masuk :
              </div>
            </div>
