/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d25054b926231c8cbb4d327f6763ea10)
// Runtime types generated with workerd@1.20250927.0 2025-10-11 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/hono/index");
	}
	interface Env {
		VITE_YEAR: string;
		BUCKET: R2Bucket;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_YEAR">> {}
}
